 ...
 *
 * @param t Puntero a la tarea que se desea agreagar.
 *
 * @return true si la tarea fue agregada exitosamente.
 */
...
/**
 * Crea una nueva tarea en memoria dinámica. Por defecto, la tarea es creada en estado deshabilitada.
 *
 ...
 *
 * @return Puntero a nueva tarea en el heap. NULL si hubó un error.
 */
